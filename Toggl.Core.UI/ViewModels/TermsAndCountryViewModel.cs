...
namespace Toggl.Core.UI.ViewModels
{
    ...
    public sealed class TermsAndCountryViewModel : ViewModelWithOutput<ICountry?>
    {
        ...
        private void accept()
        {
            analyticsService.TaCAgreeButtonTapped.Track();
            Close(country);
        }
        ...
        private void setCountryErrorIfNeeded()
        {
            ...
            analyticsService.TaCCountryNotSelected.Track();
        ...
        private async Task pickCountry()
        {
            ...
            analyticsService.TaCSelectedCountry.Track(selectedCountry.CountryCode);
